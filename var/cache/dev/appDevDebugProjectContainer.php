...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'hm_main.riotapi' => 'getHmMain_RiotapiService',
            'hm_main.syncdata' => 'getHmMain_SyncdataService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 3306, 'dbname' => 'hellomates', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\HM\\MainBundle\\Entity'))), 'HM\\MainBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('HMMainBundle' => 'HM\\MainBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_7d85e385d535bd7b6193d52d7c70c27d1dec255bfe650825d44efd3e8ac06c8b');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('HM\\MainBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('HM\\MainBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('HM\\MainBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('HM\\MainBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'HM\\MainBundle\\Entity\\User');
    }
    ...
    /**
     * Gets the 'hm_main.riotapi' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \HM\MainBundle\RiotApi\HMRiotApi A HM\MainBundle\RiotApi\HMRiotApi instance.
     */
    protected function getHmMain_RiotapiService()
    {
        return $this->services['hm_main.riotapi'] = new \HM\MainBundle\RiotApi\HMRiotApi('ae40fd1c-bde8-4469-88b1-9de346aaefad');
    }

    /**
     * Gets the 'hm_main.syncdata' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \HM\MainBundle\SyncData\HMSyncData A HM\MainBundle\SyncData\HMSyncData instance.
     */
    protected function getHmMain_SyncdataService()
    {
        return $this->services['hm_main.syncdata'] = new \HM\MainBundle\SyncData\HMSyncData($this->get('hm_main.riotapi'), $this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\HM\\MainBundle/Resources/views'), 'HMMain');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'HMMainBundle' => 'HM\\MainBundle\\HMMainBundle',
            ...
            'riotapi_key' => 'ae40fd1c-bde8-4469-88b1-9de346aaefad',
            'locale' => 'en',
            ...
            'fos_user.model.user.class' => 'HM\\MainBundle\\Entity\\User',
